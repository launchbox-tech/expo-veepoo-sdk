import type { VeepooErrorCode } from "@/types/errors";
 ...
 */
export const NATIVE_REJECT_MAPPING = {
...
} as const satisfies Record<string, { code: VeepooErrorCode }>;
 ...
 */
export const ALLOWED_NATIVE_REJECT_CODES = [
...
export const VEEPOO_CODES = [
  ...
  "TIMEOUT",
  "NOT_WEARING",
] as const satisfies readonly VeepooErrorCode[];

// Compile-time exhaustiveness: any VeepooErrorCode not in VEEPOO_CODES is a TS error.
type _Exhaustive = Exclude<VeepooErrorCode, (typeof VEEPOO_CODES)[number]>;
const _exhaustive: _Exhaustive extends never ? true : false = true;
void _exhaustive;
