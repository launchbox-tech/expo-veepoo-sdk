...
function validateReadWatchFaceStyleOptions(options?: { dial_type?: WatchFaceDialType }): void {
...
function validateWatchFaceStyleSettings(s: WatchFaceStyleSettings): void {
