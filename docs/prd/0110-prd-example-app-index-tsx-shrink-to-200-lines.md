...
- **`example/src/app/components/*.tsx` (new files)**: One file per card/section listed in user stories 5–26. Each receives props (data + callbacks) and renders its own JSX with co-located styles.
