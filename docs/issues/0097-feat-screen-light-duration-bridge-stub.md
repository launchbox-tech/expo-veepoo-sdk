# 97 — feat(settings): Screen light & duration — bridge stub (#95)

> GitHub: https://github.com/launchbox-tech/expo-veepoo-sdk/issues/97
...
**Stub issue** — vertical slice to be detailed after triage (`docs/checklist.md` §7 Group C/D). Target capability area: **Screen settings: read/write brightness and screen-on duration (or vendor equivalents) when the Band exposes these flags.**. Related `DeviceFunctions` / capability hints (from checklist): **screenLight, screenLightTime**.
