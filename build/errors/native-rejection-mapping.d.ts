 ...
 */
export declare const ALLOWED_NATIVE_REJECT_CODES: readonly ["BLUETOOTH_NOT_ENABLED", "BLUETOOTH_UNAVAILABLE", "CAPABILITY_UNSUPPORTED", "CMD_FAILED", "CONNECTION_FAILED", "CONNECTION_TIMEOUT", "CONTEXT_ERROR", "DEVICE_DISCONNECTED", "DEVICE_NOT_CONNECTED", "DEVICE_NOT_FOUND", "DEVICE_NOT_READY", "DISCONNECT_ERROR", "DISCONNECT_FAILED", "INIT_ERROR", "INVALID_ACTIVITY", "INVALID_ARGUMENT", "INVALID_LANGUAGE", "INVALID_TYPE", "MODIFY_FAILED", "NO_ACTIVITY", "OPERATION_FAILED", "PASSWORD_TYPE_ERROR", "PERMISSION_DENIED", "PERMISSION_ERROR", "READ_FAILED", "REALTIME_TEST_IN_PROGRESS", "SCAN_ERROR", "SDK_NOT_AVAILABLE", "SDK_NOT_INITIALIZED", "SET_FAILED", "SET_LANGUAGE_FAILED", "START_FAILED", "STOP_FAILED", "SYNC_FAILED", "TIMEOUT", "TYPE_NOT_FOUND", "UNKNOWN", "UNSUPPORTED"];
/**
 ...
 */
export declare const VEEPOO_CODES: readonly ["UNKNOWN", "INVALID_ARGUMENT", "PERMISSION_DENIED", "CONNECTION_FAILED", "DISCONNECTION_FAILED", "BLUETOOTH_NOT_ENABLED", "DEVICE_NOT_FOUND", "OPERATION_FAILED", "SDK_NOT_INITIALIZED", "DEVICE_NOT_CONNECTED", "DEVICE_NOT_READY", "REALTIME_TEST_IN_PROGRESS", "CAPABILITY_UNSUPPORTED", "DEVICE_BUSY", "PASSWORD_REQUIRED", "TIMEOUT", "NOT_WEARING"];
