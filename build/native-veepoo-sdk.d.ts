...
export interface NativeVeepooSDKInterface extends AlarmNativeMethods, AutoMeasureNativeMethods, BandDiscoveryNativeMethods, BatteryNativeMethods, BtStatusNativeMethods, CalibrationNativeMethods, CameraNativeMethods, ContactsNativeMethods, DaySummaryNativeMethods, DeviceFunctionsNativeMethods, DeviceSwitchesNativeMethods, DeviceTimeNativeMethods, DeviceVersionNativeMethods, DfuNativeMethods, FindDeviceNativeMethods, GpsTimezoneNativeMethods, HistoricalQueryNativeMethods, LanguageNativeMethods, MusicNativeMethods, OriginDataNativeMethods, PersonalInfoNativeMethods, RealtimeTestsNativeMethods, ScreenLightNativeMethods, SedentaryReminderNativeMethods, SessionNativeMethods, SleepDataNativeMethods, SocialMsgNativeMethods, SosNativeMethods, SportModeNativeMethods, SportStepsNativeMethods, WatchFaceNativeMethods, WeatherNativeMethods, WomenHealthNativeMethods, WorldClockNativeMethods, WristFlipNativeMethods, EventListenerMethods {
}
declare let NativeModule: NativeVeepooSDKInterface;
export { NativeModule as NativeVeepooSDK };
//# sourceMappingURL=native-veepoo-sdk.d.ts.map