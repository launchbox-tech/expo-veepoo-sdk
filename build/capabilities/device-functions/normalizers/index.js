...
function normalizeDeviceFunctions(value) {
    ...
    if ((0, primitives_1.isRecord)(record.package1) ||
        (0, primitives_1.isRecord)(record.package2) ||
        (0, primitives_1.isRecord)(record.package3) ||
        (0, primitives_1.isRecord)(record.package4) ||
        (0, primitives_1.isRecord)(record.package5)) {
        return {
            ...
            package4: (0, package4_5_1.normalizePackage4)(record),
            package5: (0, package4_5_1.normalizePackage5)(record),
        };
    }
    return {
        package1: (0, package1_1.normalizePackage1)(record),
