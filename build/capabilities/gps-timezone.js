...
class GpsTimezoneCapability {
    ...
    setDeviceGPSAndTimezone(data) {
        return this.ctx.invoke({
            ...
            invoke: () => this.ctx.native.setDeviceGPSAndTimezone((0, deep_keys_1.deepCamelKeys)(data)),
        });
    }
}
exports.GpsTimezoneCapability = GpsTimezoneCapability;
//# sourceMappingURL=gps-timezone.js.map