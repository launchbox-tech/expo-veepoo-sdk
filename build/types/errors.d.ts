export type VeepooErrorCode = 'UNKNOWN' | 'INVALID_ARGUMENT' | 'PERMISSION_DENIED' | 'CONNECTION_FAILED' | 'DISCONNECTION_FAILED' | 'BLUETOOTH_NOT_ENABLED' | 'DEVICE_NOT_FOUND' | 'OPERATION_FAILED' | 'SDK_NOT_INITIALIZED' | 'DEVICE_NOT_CONNECTED' | 'DEVICE_NOT_READY' | 'REALTIME_TEST_IN_PROGRESS' | 'CAPABILITY_UNSUPPORTED' | 'DEVICE_BUSY' | 'PASSWORD_REQUIRED' | 'TIMEOUT' | 'NOT_WEARING';
