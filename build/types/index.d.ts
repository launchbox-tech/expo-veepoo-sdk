...
export type { ScreenLightSettings, ScreenLightDuration, } from '../capabilities/screen-light/types';
...
export type { WomenHealthBabySex, WomenHealthSettings, WomenHealthStatus, } from '../capabilities/women-health/types';
export type { WatchFaceDialType, WatchFaceStyle, WatchFaceStyleSettings, } from '../capabilities/watch-face';
export type { WeatherUnit, WeatherSettings, WeatherHourlyForecast, WeatherDailyForecast, WeatherData, } from '../capabilities/weather/types';
...
export type { TemperatureUnit, DistanceUnit, TimeFormat, BloodGlucoseUnit, SkinTone, OperationStatus, } from './settings';
export type { ApneaRemindSettings, CustomSettings, CustomSettingData, DeviceData, HealthReminder, HealthReminderType, VeepooEvent, VeepooEventPayload, FirmwareDfuState, FirmwareDfuProgress, } from './events';
