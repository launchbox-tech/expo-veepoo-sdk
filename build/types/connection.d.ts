...
export type BluetoothState = 'unknown' | 'resetting' | 'unsupported' | 'unauthorized' | 'powered_off' | 'powered_on';
export type BluetoothAuthorization = 'not_determined' | 'restricted' | 'denied' | 'allowed_always';
export type PermissionStatus = 'granted' | 'denied' | 'restricted' | 'unknown' | 'never_ask_again' | 'powered_off';
